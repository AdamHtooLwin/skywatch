...
from models.meta_fas import scan
...
if __name__ == "__main__":
    ...
    model = scan.SCAN(pretrained=True)
    state_dict = torch.load(configs['weights'], map_location='cpu')

    # replace module. prefix in params since learn2learn wrapped it in it i think
